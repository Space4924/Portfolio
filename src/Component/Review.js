...
const Review = () => {
  ...
  <div class="container px-5 py-5 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">If Any Case You Want to Ask Me or Tell Me Anything</p>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <div class="text-indigo-500">bhoopendra_s@ar.iitr.ac.in</div>
          <p class="leading-normal my-5">EG-12 , Jawahar Bhawan 
            <br/>8864824924
          </p>
